...
goal_guidelines = {
    ...
    - 한식 위주로 구성하되, 필요 시 서양식도 가능.""",

    "근육량 증가": """근육 성장을 위한 고단백 식단을 제공해야 해.
    - 하루 1,900kcal 기준으로 구성.
    - 단백질 섭취량을 높이고, 탄수화물은 복합탄수화물 중심으로 제공.
    ...
    - 잡곡밥(현미, 보리) 위주로 구성하지만, 기호에 따라 쌀밥도 허용.
    - 고기, 생선, 두부 등의 단백질 반찬을 골고루 포함하되, 기름기와 껍질 제거한 살코기 사용.
    - 제철 채소 활용 및 싱겁게 조리, 염장식품(김치, 장아찌) 피하기.
    - 간식은 제철 과일과 저지방 우유를 활용.
    - 튀김 대신 굽기, 찜, 삶는 조리법 사용 (적당량의 식물성 기름 허용).
    - 하루 염분량은 소금 기준 3g 이하로 제한.""",
}
